...
public class Server
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        ServerSocket ss = new ServerSocket(59298);
        ...
        while (true)
        {
            ...
            try
            {
                ...
                ClientHandler t =  new ClientHandler(s, dis, dos, whichClient, serverStatus);
                ...
                //serverStatus.updateLabel(clients.size());
